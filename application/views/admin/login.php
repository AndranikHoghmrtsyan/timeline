                          ...
                          <form role="form" action="<?php echo base_url('admin/check_admin')?>" method="post" class="login-form">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="password" name="pass" placeholder="Գաղտնաբառ..." class="form-password form-control" id="form-password">
                              </div>
                              <button type="submit" class="btn" style="background-color:#009EDF;color:white">Մտնել</button>
                          </form>
                                                    <h4 style="color:red">
                           <?php
